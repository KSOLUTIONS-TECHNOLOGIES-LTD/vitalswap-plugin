...
class WC_Gateway_VitalSwap_Two extends WC_Gateway_Custom_VitalSwap
{
	...
	/**
	 * WC_Gateway_VitalSwap_Two constructor.
	 */
	public function __construct()
	{

		$this->id = 'vitalswap-two';

		$gateway_title = $this->get_option('title');

		if (empty($gateway_title)) {
			$gateway_title = __('Two', 'vitalswap');
		}
