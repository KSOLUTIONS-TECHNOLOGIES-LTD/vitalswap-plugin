...
class WC_Gateway_Vitalswap_Four extends WC_Gateway_Custom_Vitalswap
{
	...
	/**
	 * WC_Gateway_vitalswap_Four constructor.
	 */
	public function __construct()
	{

		$this->id = 'vitalswap-four';

		$gateway_title = $this->get_option('title');

		if (empty($gateway_title)) {
			$gateway_title = __('Four', 'vitalswap');
		}
