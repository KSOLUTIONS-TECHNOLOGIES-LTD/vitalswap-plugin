...
class WC_Gateway_VitalSwap_Five extends WC_Gateway_Custom_VitalSwap
{
	...
	/**
	 * WC_Gateway_VitalSwap_Five constructor.
	 */
	public function __construct()
	{

		$this->id = 'vitalswap-five';

		$gateway_title = $this->get_option('title');

		if (empty($gateway_title)) {
			$gateway_title = __('Five', 'vitalswap');
		}
		...
		$this->method_description = sprintf(__('VitalSwap provide merchants with the tools and services needed to accept online payments from local and international customers using Mastercard, Visa, Verve Cards and Bank Accounts. <a href="%1$s" target="_blank">Sign up</a> for a VitalSwap account, and <a href="%2$s" target="_blank">get your API keys</a>.', 'vitalswap'), 'https://vitalswap.com', 'https://business.vitalswap.com/#/settings/developer');
