...
class WC_Gateway_VitalSwap_Five extends WC_Gateway_Custom_VitalSwap {
	...
	public function __construct() {
		...
		if ( empty( $gateway_title ) ) {
			$gateway_title = __( 'Five', 'woo-vitalswap' );
		}

		$this->method_title       = sprintf( __( 'VitalSwap - %s', 'woo-vitalswap' ), $gateway_title );
		$this->method_description = sprintf( __( 'VitalSwap provide merchants with the tools and services needed to accept online payments from local and international customers using Mastercard, Visa, Verve Cards and Bank Accounts. <a href="%1$s" target="_blank">Sign up</a> for a VitalSwap account, and <a href="%2$s" target="_blank">get your API keys</a>.', 'woo-vitalswap' ), 'https://vitalswap.com', 'https://business.vitalswap.com/#/settings/developer' );
