...
class WC_Gateway_VitalSwap_One extends WC_Gateway_Custom_VitalSwap
{
	...
	/**
	 * WC_Gateway_VitalSwap_One constructor.
	 */
	public function __construct()
	{

		$this->id = 'vitalswap-one';

		$gateway_title = $this->get_option('title');

		if (empty($gateway_title)) {
			$gateway_title = __('One', 'vitalswap');
		}
