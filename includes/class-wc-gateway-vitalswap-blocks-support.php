...
final class WC_Gateway_VitalSwap_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function initialize() {
		$this->settings = get_option( 'woocommerce_vitalswap_settings', array() );
	...
	public function get_payment_method_script_handles() {
		$script_asset_path = plugins_url( '/assets/js/blocks/frontend/blocks.asset.php', WC_VitalSwap_MAIN_FILE );
		...
		$script_url = plugins_url( '/assets/js/blocks/frontend/blocks.js', WC_VitalSwap_MAIN_FILE );
	...
	public function failed_payment_notice( PaymentContext $context, PaymentResult &$result ) {
		if ( 'VitalSwap' === $context->payment_method ) {
			add_action(
